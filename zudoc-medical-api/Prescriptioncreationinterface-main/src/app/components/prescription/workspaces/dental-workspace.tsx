    ...
    <div className="flex flex-col h-full bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-gray-100 bg-gray-50/50 flex items-center justify-between sticky top-0 z-20 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          <div className="size-10 bg-cyan-600 rounded-lg flex items-center justify-center shadow-lg shadow-cyan-200">
            <Pencil className="size-5 text-white" />
          </div>

          <div>
            <h2 className="text-lg font-bold text-gray-900">Dental Portal</h2>
            <p className="text-xs text-gray-500 font-medium">Create dental prescription</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-8">
        {/* Symptoms */}
        <div id="symptoms">
          <KeyboardTagInput workspaceId="dental"
            value={symptomTags}
            onChange={handleSymptomsChange}
            suggestions={mockSymptoms}
            snomedHierarchy={SNOMED_HIERARCHIES.DENTAL_SYMPTOMS}
            placeholder="Type symptoms and press Enter..."
            label="Symptoms"
            onEnterNext={() => diagnosisRef.current?.querySelector('input')?.focus()}
            zenMode={zenMode}
            onFieldFocus={(field, query) => onFieldFocusInternal('dental_symptoms', query)}
        ...
        <div id="diagnosis" ref={diagnosisRef}>
          <KeyboardTagInput workspaceId="dental"
            ...
            snomedHierarchy={SNOMED_HIERARCHIES.DENTAL_DIAGNOSIS}
            placeholder="Type diagnosis and press Enter..."
            label="Diagnosis"
            required
            onEnterNext={() => disorderRef.current?.querySelector('input')?.focus()}
            zenMode={zenMode}
            onFieldFocus={(field, query) => onFieldFocusInternal('dental_diagnosis', query)}
            onArrowDownInField={onArrowDownInField}
          />
        </div>
        ...
        <div id="disorder" ref={disorderRef}>
          <KeyboardTagInput workspaceId="dental"
            ...
            zenMode={zenMode}
            onFieldFocus={(field, query) => onFieldFocusInternal('dental_disorders', query)}
            onArrowDownInField={onArrowDownInField}
          />
        </div>
          ...
          <Tabs defaultValue="medications" className="w-full">
              ...
              <div className="space-y-4">
                ...
                {showMedicationForm && (
                  <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                    <ImprovedMedicationForm workspaceId="dental"
                      onAdd={(med) => {
                        onAddMedication(med);
            ...
            <TabsContent value="labs" className="mt-0 focus-visible:outline-none">
              <div className="space-y-4">
                ...
                {showLabTestForm && (
                  <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                    <LabTestForm workspaceId="dental"
                      onAdd={(test) => {
            ...
            <TabsContent value="radiology" className="mt-0 focus-visible:outline-none">
              <div className="space-y-4">
                ...
                {showRadiologyForm && (
                  <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                    <RadiologyForm workspaceId="dental"
                      onAdd={(order) => {
            ...
            <TabsContent value="surgery" className="mt-0 focus-visible:outline-none">
              <div className="space-y-4">
                ...
                {showSurgeryForm && (
                  <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                    <SurgeryForm workspaceId="dental"
                      onAdd={(order) => {
